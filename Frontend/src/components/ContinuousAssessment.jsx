...
export default function ContinuousAssessment() {
  ...
  useEffect(() => {
    let timer;
    if (currentTest < TESTS.length && !showInstructions && !showCountdown && !loadingTest && timeRemaining > 0) {
      timer = setInterval(() => {
  ...
  }, [currentTest, showInstructions, showCountdown, loadingTest, timeRemaining]);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-white p-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">Please select a student before starting the assessment</p>
          <motion.button
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
        ...
        >
          ...
          >
            <h3 className="text-gray-700 font-medium mb-4">Assessment sections:</h3>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white p-4 overflow-x-hidden">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center">
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${test.gradientFrom} ${test.gradientTo} flex items-center justify-center text-2xl text-white shadow-sm mr-4`}>
                  {test.icon}
                </div>
                <div>
                  <h2 className="font-semibold text-gray-800 text-lg">{test.name}</h2>
              ...
              <div className="w-1/3">
                <div className="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
                  <motion.div 
                    ...
                    initial={{ width: `${((currentTest) / TESTS.length) * 100}%` }}
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-blue-50 p-4">
        ...
        >
          ...
          <motion.div
            ...
            transition={{ delay: 0.3, duration: 0.5 }}
          >
            <h2 className="text-3xl font-bold text-gray-800 mb-3">Assessment Complete!</h2>
            <p className="text-gray-600 mb-8 text-lg">
              Well done! You've completed all tests for <span className="font-semibold">{student.name}</span>
            </p>
          </motion.div>
        ...
        >
          ...
          <div className="divide-y divide-gray-100">
            {results.map((result, index) => (
              ...
              >
                <div className="flex items-center">
                  <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${result.gradientFrom} ${result.gradientTo} flex items-center justify-center text-2xl text-white shadow-sm mr-4`}>
                    {result.icon}
                  </div>
                  <div className="flex-grow">
                    <h3 className="font-medium text-gray-800">{result.name}</h3>
  ...
  />
                  ...
                  <div className="ml-4">
                    <div className={`text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r ${result.gradientFrom} ${result.gradientTo}`}>
                      {result.score}/10
                    </div>
                  </div>
                </div>
          ...
          >
            <div className="flex flex-col items-center sm:items-start">
              <span className="text-sm text-gray-500 mb-1">Overall Performance</span>
              <div className="flex items-center">
                  ...
                  {Array.from({ length: 5 }).map((_, i) => {
                    ...
                    return (
                      <svg 
                        ...
                        className={`h-5 w-5 ${i < Math.round(avgScore) ? 'text-yellow-400' : 'text-gray-300'}`} 
                        viewBox="0 0 20 20" 
                        fill="currentColor"
                      >
                ...
                <span className="text-gray-700 font-medium">
                  {(() => {
                    const totalScore = results.reduce((sum, result) => sum + (Number(result.score) || 0), 0);
                    const percentage = (totalScore / (results.length * 10)) * 100;
          ...
          >
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {results.filter(r => r.score < 6).map((result, index) => (
                  <motion.div 
                    key={index}
                  ...
                  >
                    <div className="flex items-center mb-2">
                      <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${result.gradientFrom} ${result.gradientTo} flex items-center justify-center text-lg text-white mr-2`}>
                        {result.icon}
                      </div>
                    ...
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-green-700 text-sm">
                          All skills show good proficiency. Continue with advanced exercises to maintain progress.
                        </p>
                      </div>
                    </div>
                  </motion.div>
